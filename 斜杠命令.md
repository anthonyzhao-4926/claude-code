...
你可以把它理解成编辑 Word 文档时的撤销，或者 [Git](https://zhida.zhihu.com/search?content_id=275314719&content_type=Article&match_order=1&q=Git&zd_token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJ6aGlkYV9zZXJ2ZXIiLCJleHAiOjE3ODE3NDU0MDUsInEiOiJHaXQiLCJ6aGlkYV9zb3VyY2UiOiJlbnRpdHkiLCJjb250ZW50X2lkIjoyNzUzMTQ3MTksImNvbnRlbnRfdHlwZSI6IkFydGljbGUiLCJtYXRjaF9vcmRlciI6MSwiemRfdG9rZW4iOm51bGx9.aE415yPGerLQDyPRbhOGpPtuJvaDCoUJVu8DUPDltVQ&zhida_source=entity) 里的版本回滚，它同时回退对话记录和文件改动。
...
在 Claude 改了很多文件之后，提交代码前用 `/diff` 过一遍是个好习惯。不过在终端的小黑框里看代码 diff 还是挺痛苦的，如果改动比较多，建议还是配合 VS Code 的 Git [插件](https://zhida.zhihu.com/search?content_id=275314719&content_type=Article&match_order=1&q=插件&zd_token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJ6aGlkYV9zZXJ2ZXIiLCJleHAiOjE3ODE3NDU0MDUsInEiOiLmj5Lku7YiLCJ6aGlkYV9zb3VyY2UiOiJlbnRpdHkiLCJjb250ZW50X2lkIjoyNzUzMTQ3MTksImNvbnRlbnRfdHlwZSI6IkFydGljbGUiLCJtYXRjaF9vcmRlciI6MSwiemRfdG9rZW4iOm51bGx9.LTtGVwIwAX4nPZSnOGmv9CTxl-crSJJ6tUd4vN_V_4Q&zhida_source=entity)或其他支持可视化代码对比的 IDE 来看，体验会好很多。
...
这三个命令分别用来管理 MCP 服务器连接、[Skills 技能列表](https://zhida.zhihu.com/search?content_id=275314719&content_type=Article&match_order=1&q=Skills+技能列表&zd_token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJ6aGlkYV9zZXJ2ZXIiLCJleHAiOjE3ODE3NDU0MDUsInEiOiJTa2lsbHMg5oqA6IO95YiX6KGoIiwiemhpZGFfc291cmNlIjoiZW50aXR5IiwiY29udGVudF9pZCI6Mjc1MzE0NzE5LCJjb250ZW50X3R5cGUiOiJBcnRpY2xlIiwibWF0Y2hfb3JkZXIiOjEsInpkX3Rva2VuIjpudWxsfQ.AfNzRaoYoJd3GLc-pn5zfspLBJd3YjjsqPCwWS4r1no&zhida_source=entity)和插件。
